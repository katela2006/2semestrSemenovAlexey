...
5) Используя созданный список считаем скорость для первого элемента по формуле
6) Смещая срез находим стоимости относительно всех пунктов
7) Стоимости пунктов накапливаем в списке и после берем индекс минимальной из них +1(поправка к нумерации)
## b:
Актуально всё то, что в а, но цикл перебора нужно организовать по диапазону, в аргументе которого есть старт финиш и шаг
